...
import TaskDetailDialogForm from "../../work-request/task-detail/TaskDetailDialogForm";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import { deleteTaskDetailData, insertTaskDetailData, updateTaskDetailData, useCmTaskDetailData } from "../hooks/cm/use-cm-task-detail-data";

interface CmTaskDetailPageProps {
  cmGeneralId: number; // Passed as a prop to this page
}

const CmTaskDetailPage: React.FC<CmTaskDetailPageProps> = ({ cmGeneralId }) => {
  const { data: tasks, isLoading, refetch } = useCmTaskDetailData(cmGeneralId);
...
export default CmTaskDetailPage;