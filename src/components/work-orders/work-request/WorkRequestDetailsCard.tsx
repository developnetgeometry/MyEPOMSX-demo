                ...
                <TooltipProvider>
                  ...
                  {((workRequest.cm_status_id?.id === 1 || workRequest.cm_status_id?.id === -1) &&
                    <>
                      <Tooltip>
                        ...
                        <TooltipContent>Change from "Draft" to "NRQ"</TooltipContent>
                      </Tooltip>
                    </>
                  )}
                  {(workRequest.cm_status_id?.id === 2 &&
                    <>
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                        <Button variant="outline">Approve (ME/OE)</Button>
                        </TooltipTrigger>
                        <TooltipContent>Change from "Draft" to "WO Raised". <br/>Pass to ME/OE</TooltipContent>
                      </Tooltip>
                      <Tooltip>
                        <TooltipTrigger asChild>
                        <Button variant="outline">Approve (TS)</Button>
                        </TooltipTrigger>
                        <TooltipContent>Change from "Draft" to "WO Raised". <br/>Pass to TS</TooltipContent>
                      </Tooltip>
                    </>
                  )}
                </TooltipProvider>
