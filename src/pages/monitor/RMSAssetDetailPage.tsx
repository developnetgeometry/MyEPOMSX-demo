...
const RMSAssetDetailPage: React.FC = () => {
  ...
  const { data: asset, isLoading, error } = useAsset(parseInt(id || "0"));
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p>
                      {asset.commission_date
                        ? formatDateTime(asset.commission_date)
                        : "N/A"}
                    </p>
                  </div>
                  <div>
                ...
                <div className="mt-4">
                  ...
                  <p className="mt-1">
                    {asset.asset_detail?.specification ||
                      ...
                      workOrders.map((workOrder) => (
                        <TableRow key={workOrder.id}>
                          ...
                          <TableCell>
                            <Badge
                              className={
                                workOrder.work_order_type?.id === 1
                                  ? "bg-red-500"
                                  : " bg-blue-500"
                              }
                            >
                              {workOrder.work_order_type?.id === 1
                                ? "CM"
                                : workOrder.work_order_type?.id === 2
                                ? "PM"
                                : "N/A"}
                            </Badge>
                          </TableCell>
