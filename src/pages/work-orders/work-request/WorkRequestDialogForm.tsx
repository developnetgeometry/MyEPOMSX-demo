...
interface WorkRequestDialogFormProps {
  ...
  assetId?: number; // Optional asset ID for new requests
}

const WorkRequestDialogForm: React.FC<WorkRequestDialogFormProps> = ({ onSubmit, onCancel, initialData = null, assetId }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    asset_id: initialData?.asset_id?.id || assetId || null,
