      ...
      const errorPatterns = {
        systemCodeDuplicate: {
          patterns: [
            ...
            "system_code already exists",
            "unique constraint system_code",
          ],
          title: "Duplicate System Code",
          description:
            "This System Code already exists. Please use a different System Code.",
        },
        systemNameDuplicate: {
          patterns: [
            "duplicate system_name",
            "system_name already exists",
            "unique constraint system_name",
          ],
          title: "Duplicate System Name",
          description:
            "This System Name already exists. Please use a different name.",
        },
        networkError: {
        ...
        permissionError: {
          ...
          description:
            "You do not have permission to update this system. Please contact your administrator.",
        },
      };
